...
classdef asValueChangerClass < handle
    ...
    methods
        ...
        function obj = asValueChangerClass(parentPanelHandle, varargin)
            ...
            htmlToolTip = sprintf([...
                'Data selection control (Dimension %d)\n\n',...
                'Up arrow: Increase value\n',...
                'Down arrow: Decrease value\n',...
                'PageUp: Set value to 1\n',...
                'PageDown: Set value to end\n',...
                'Left arrow: Select left neighbour\n',...
                'Right arrow: Select right neighbour\n\n',...
                'Hints:\n',...
                '- Open context menu to perform operations along this dimension\n',...
                '- Use the mouse wheel to increase or decrease values'], obj.id);
            ...
            vCorr = 0;
            htmlToolTip = sprintf([...
                'Colon dimension quick toggle (Dimension %d, size: %d)\n\n',...
                'Left click: Toggle 1st colon dimension\n',...
                'Right click: Toggle 2nd colon dimension\n',...
                'Ctrl+click: Set to plot dimension\n\n',...
                'Description:\n',...
                'The colon dimension toggle can be used to quickly insert a colon (:) into the selection string of the respective dimension. ',...
                'This can be useful to switch between orientations (coronal, sagittal, transversal).\n',...
                'Colon dimensions are also protected against value changes via mouse wheel.\n\n',...
                'It is possible to manually put additional colons into other dimensions, yielding a multiframe view.\n\n',...
                'The plot dimension tag is used by several sub functions, for example to create 1D plots along this dimension (v).'], ...
                obj.id, obj.max);
        ...
        function select(obj)
            %#ok<MANU>
            % Keep selection as internal state only. Forcing focus onto a
            % uicontrol triggers unstable focus-listener teardown in recent
            % MATLAB releases after figures are closed and reopened.
        end
